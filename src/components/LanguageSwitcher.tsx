  ...
  return (
    <div className="relative group">
      <button
        ...
        className="relative flex items-center space-x-2 px-3 py-2 rounded-xl glass border border-[#FFD700]/20 hover:border-[#FFD700]/50 hover-lift transition-all duration-300 hover:scale-105"
      >
        <span className="text-sm text-[#FFD700] font-bold">{currentLang.flag}</span>
        <ChevronDown 
              ...
              <button
                ...
                className={`w-full flex items-center justify-center px-4 py-3 hover:bg-[#1c1c1c] transition-all duration-200 rounded-xl mx-1 ${
                  language.code === activeLanguage 
                    ? 'text-[#FFD700] glass border border-[#FFD700]/30' 
