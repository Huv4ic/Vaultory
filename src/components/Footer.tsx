...
const Footer = () => {
  ...
  return (
    <footer className="bg-black/90 backdrop-blur-xl border-t border-red-500/30 relative overflow-hidden">
      {/* Анимированные световые эффекты */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-red-500/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6 group">
              ...
              <div className="w-8 h-8 sm:w-10 sm:h-10 relative transform group-hover:scale-110 transition-all duration-500">
                <div className="absolute inset-0 bg-black/80 backdrop-blur-xl rounded-lg sm:rounded-xl flex items-center justify-center shadow-2xl shadow-purple-500/30 group-hover:shadow-red-500/50 border border-purple-500/30 group-hover:border-red-500/50 transition-all duration-500">
              ...
              <span className="text-xl sm:text-2xl font-bold text-white group-hover:text-red-400 transition-all duration-500 drop-shadow-[0_0_8px_rgba(220,38,38,0.3)] group-hover:drop-shadow-[0_0_12px_rgba(220,38,38,0.6)]">
                Vaultory
              </span>
            </div>
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a 
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 bg-red-600/80 backdrop-blur-xl rounded-full flex items-center justify-center text-white hover:bg-red-700/90 transition-all duration-300 hover:scale-110 shadow-lg shadow-red-500/25 hover:shadow-red-500/40 border border-red-500/30 hover:border-red-400/50"
              >
              ...
              <button 
                onClick={openGmail}
                className="w-8 h-8 sm:w-10 sm:h-10 bg-purple-600/80 backdrop-blur-xl rounded-full flex items-center justify-center text-white hover:bg-purple-700/90 transition-all duration-300 hover:scale-110 shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 border border-purple-500/30 hover:border-purple-400/50"
              >
          ...
          {/* Быстрые ссылки */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3 sm:mb-4 hover:text-red-400 transition-colors duration-300">
              {t('Быстрые ссылки')}
            </h3>
        ...
        {/* Нижняя часть */}
        <div className="border-t border-red-500/20 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center relative">
          {/* Анимированная линия */}
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-px bg-gradient-to-r from-transparent via-red-500/50 to-transparent"></div>
