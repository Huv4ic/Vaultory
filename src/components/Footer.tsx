  ...
  return (
    <footer className="bg-gradient-to-r from-black via-gray-900 to-black border-t border-amber-500/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-amber-500/5 rounded-full blur-3xl animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 bg-gradient-to-r from-amber-500 to-emerald-500 rounded-full flex items-center justify-center text-white hover:from-amber-600 hover:to-emerald-600 transition-all duration-300 hover:scale-110 shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40"
              >
          ...
          {/* Быстрые ссылки */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4 bg-gradient-to-r from-amber-400 to-emerald-400 bg-clip-text text-transparent">
              {t('Быстрые ссылки')}
            </h3>
