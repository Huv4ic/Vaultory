...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-black via-gray-900 to-black border-t border-red-500/30 relative overflow-hidden">
      {/* Темный анимированный фон */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 bg-red-500/5 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-purple-500/5 rounded-full blur-2xl sm:blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6 group">
              ...
              <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-red-500 via-purple-400 to-slate-300 bg-clip-text text-transparent group-hover:from-red-400 group-hover:via-purple-300 group-hover:to-white transition-all duration-500 drop-shadow-[0_0_8px_rgba(220,38,38,0.3)]">
                Vaultory
              </span>
            </div>
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a 
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-red-600 to-purple-700 rounded-full flex items-center justify-center text-white hover:from-red-700 hover:to-purple-800 transition-all duration-300 hover:scale-110 shadow-lg shadow-red-500/25 hover:shadow-red-500/40"
              >
              ...
              <button 
                onClick={openGmail}
                className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-600 to-slate-700 rounded-full flex items-center justify-center text-white hover:from-purple-700 hover:to-slate-800 transition-all duration-300 hover:scale-110 shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40"
              >
          ...
          {/* Быстрые ссылки */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3 sm:mb-4 bg-gradient-to-r from-red-400 to-purple-400 bg-clip-text text-transparent">
              {t('Быстрые ссылки')}
            </h3>
        ...
        {/* Нижняя часть */}
        <div className="border-t border-red-500/20 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center">
