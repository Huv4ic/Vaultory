          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group relative">
              <div className="relative glass rounded-3xl border border-[#FFD700]/20 p-6 hover:border-[#FFD700]/50 hover-lift hover-glow transition-all duration-300 hover:scale-105 text-center min-h-[240px] flex flex-col justify-between">
                ...
                <p className="text-lg text-[#c0c0c0] leading-relaxed">Помощь в любое время дня и ночи</p>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="relative glass rounded-3xl border border-[#FFD700]/20 p-6 hover:border-[#FFD700]/50 hover-lift hover-glow transition-all duration-300 hover:scale-105 text-center min-h-[240px] flex flex-col justify-between">
                ...
                <p className="text-lg text-[#c0c0c0] leading-relaxed">Решаем вопросы в кратчайшие сроки</p>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="relative glass rounded-3xl border border-[#FFD700]/20 p-6 hover:border-[#FFD700]/50 hover-lift hover-glow transition-all duration-300 hover:scale-105 text-center min-h-[240px] flex flex-col justify-between">
                ...
                <p className="text-lg text-[#c0c0c0] leading-relaxed">Конфиденциальность ваших данных</p>
              </div>
            </div>
            ...
            <div className="group relative">
              <div className="relative glass rounded-3xl border border-[#FFD700]/20 p-6 hover:border-[#FFD700]/50 hover-lift hover-glow transition-all duration-300 hover:scale-105 text-center min-h-[240px] flex flex-col justify-between">
                ...
                <p className="text-lg text-[#c0c0c0] leading-relaxed">Профессиональный подход к каждому клиенту</p>
              </div>
            </div>
          </div>
        </div>
