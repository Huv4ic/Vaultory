            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {importantNotes.map((note, index) => (
                  <div key={index} className="flex items-center space-x-3 p-4 bg-black/50 backdrop-blur-sm rounded-xl border border-amber-500/20">
                    {note.icon}
                    <span className="text-gray-300 text-sm">{note.text}</span>
                  </div>
                ))}
              </div>
            </CardContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-300 text-sm">Покупка товаров для личного использования</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-amber-400" />
                      <span className="text-gray-300 text-sm">Открытие кейсов в разумных пределах</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-amber-400" />
                      <span className="text-gray-300 text-sm">Обращение в службу поддержки</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-300 text-sm">Использование ботов и автоматизации</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <XCircle className="w-4 h-4 text-red-400" />
                      <span className="text-gray-300 text-sm">Нарушение правил игр</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <XCircle className="w-4 h-4 text-red-400" />
                      <span className="text-gray-300 text-sm">Попытки обмана системы</span>
                    </div>
                  </div>
                </div>
              </div>
