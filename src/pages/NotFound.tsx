      ...
      <div className="relative z-20 container mx-auto px-4 pb-12 sm:pb-16 md:pb-20">
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
            <div className="glass rounded-2xl border border-white/9 p-5 sm:p-6 text-center hover:border-white/15 hover-lift transition-all duration-300">
              <div className="mx-auto w-12 h-12 sm:w-16 sm:h-16 glass rounded-full flex items-center justify-center mb-3 sm:mb-4 border border-white/9">
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-8">
            ...
            <Button
              onClick={() => navigate('/')}
              variant="outline"
              className="px-6 sm:px-8 py-2 sm:py-3 glass border border-white/9 text-[#a0a0a0] hover:bg-white/5 hover:border-white/15 hover-lift hover:text-[#f0f0f0] transition-all duration-300 rounded-xl text-sm sm:text-base"
            >
